...
import { budgets, upcomingTransactions, weeklyBars } from '@/lib/mock-finance';
    ...
    <View className="flex-1 bg-[#060b08]">
      ...
      <ScrollView
        ...
        <View className="rounded-b-[36px] bg-[#0b120e] px-6 pb-8 pt-safe pt-4">
          ...
          <View className="mt-7 rounded-[30px] border border-[#1b2a21] bg-[#111916] p-5">
        ...
        <View className="gap-5 px-6 pt-6">
          <View className="rounded-[30px] border border-[#17211c] bg-[#0f1512] p-5">
            <View className="flex-row items-start justify-between gap-3">
              ...
              <Button
                className="h-12 rounded-full bg-[#8bff62] px-5"
                variant="ghost"
                size="sm">
